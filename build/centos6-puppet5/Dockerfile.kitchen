...
# docker build -t stackstorm/puppet-st2-centos6 -f build/centos6-puppet5/Dockerfile.kitchen .
...
# install puppet
RUN yum -y install https://yum.puppetlabs.com/puppet5/puppet5-release-el-6.noarch.rpm
