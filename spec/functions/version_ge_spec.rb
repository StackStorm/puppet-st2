  ...
  on_supported_os.each do |os, os_facts|
    context "on #{os}" do
      context 'when StackStorm is not installed' do
        let(:facts) { os_facts.merge(st2_version: nil) }
      ...
      context 'when StackStorm is installed' do
        context 'and st2::version = "present"' do
          ...
          let(:facts) { os_facts.merge(st2_version: '2.9.0', 'st2::version' => 'present') }
        ...
        context 'and st2::version = "installed"' do
          ...
          let(:facts) { os_facts.merge(st2_version: '2.9.0', 'st2::version' => 'installed') }
        ...
        context 'and st2::version = "latest"' do
          ...
          let(:facts) { os_facts.merge(st2_version: '2.9.0', 'st2::version' => 'latest') }
        ...
        context 'and st2_version = "2.9.0" st2::version = "2.9.0"' do
          ...
          let(:facts) { os_facts.merge(st2_version: '2.9.0', 'st2::version' => '2.9.0') }
        ...
        context 'and st2_version = "2.9.0" st2::version = "2.10.0"' do
          ...
          let(:facts) { os_facts.merge(st2_version: '2.9.0', 'st2::version' => '2.10.0') }
        ...
        context 'and st2_version = "2.10.0" st2::version = "2.9.0"' do
          let(:pre_condition) { "class {'st2': version => '2.9.0' }" }
          let(:facts) { os_facts.merge(st2_version: '2.10.0', 'st2::version' => '2.9.0') }
